...
def save
  ...
  ShippingAddress.create(postal_code: postal_code, item_prefecture_id: item_prefecture_id, city: city, address: address, building: building, order_id: order.id, phone_number: phone_number)
end
end